...
• New features: helical hydrophobic moment (μH), amphipathic index, Cys-topology/motifs
• Guardrails (CPP/hydrophobic traps, length), deterministic free tier
• CSV/FASTA batch prediction, clean CLI, JSON training summaries
• Classification heads (eg. AMP/Toxicity/Stability/CPP) + Regression heads (eg. MIC)
